...
typedef struct {
  ...
  boolean_T DigitalPortRead_f;         /* '<S8>/Digital Port Read' */
} B_BasicKit_T;
 ...
 * '<S2>'   : 'BasicKit/Digital Port Read'
 * '<S3>'   : 'BasicKit/Digital Port Read1'
 ...
 * '<S7>'   : 'BasicKit/Digital Port Read/ECSoC'
 * '<S8>'   : 'BasicKit/Digital Port Read/ECSoC/ECSimCodegen'
 * '<S9>'   : 'BasicKit/Digital Port Read1/ECSoC'
 * '<S10>'  : 'BasicKit/Digital Port Read1/ECSoC/ECSimCodegen'
