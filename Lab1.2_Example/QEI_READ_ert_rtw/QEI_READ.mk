...
COMPILER_COMMAND_FILE     = QEI_READ_comp.rsp
CMD_FILE                  = QEI_READ.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/QEI_READ.elf
...
DEFINES_STANDARD = -DMODEL=QEI_READ -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
%.o : $(START_DIR)/QEI_READ_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/QEI_READ_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/QEI_READ_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/QEI_READ_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/QEI_READ_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
QEI_READ.o : $(START_DIR)/QEI_READ_ert_rtw/QEI_READ.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/QEI_READ_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"
...
syscalls.o : $(START_DIR)/QEI_READ/STM32CubeIDE/Application/User/Core/syscalls.c
	$(CC) $(CFLAGS) -o "$@" "$<"


sysmem.o : $(START_DIR)/QEI_READ/STM32CubeIDE/Application/User/Core/sysmem.c
	$(CC) $(CFLAGS) -o "$@" "$<"


startup_stm32g474retx.o : $(START_DIR)/QEI_READ/STM32CubeIDE/Application/User/Startup/startup_stm32g474retx.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
